...
shot 04-bar.png           s "Top bar close-up: workspaces, the blue close-window button (left of the title), window title, tray, the custom modules (coffee = lid keep-awake, eye = conky, volume). Region over the bar."
...
shot 10-swaylock.png      f "Lock screen (duck in the ring). Tricky to self-capture: easiest is 'sleep 4; grim -o <output> 10-swaylock.png &' then lock; or skip and shoot later."
